...
output "asg_security_group_id" { value = module.sg.sg_id }
...
#utput "asg_iam_role_policy_attachment"           { value = module.asg.asg_iam_role_policy_attachment }
#utput "asg_iam_role_policy_attachment_pos"       { value = module.asg.asg_iam_role_policy_attachment_pos }
#utput "asg_iam_role_policy_inline"               { value = module.asg.asg_iam_role_policy_inline    }
...
#utput "asg_launch_template_block_device_mappings" { value = module.asg.asg_launch_template_block_device_mappings }
